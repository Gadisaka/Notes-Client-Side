...
const Navbar = () => {
  return (
    <>
      <ul className="bg-white h-16 flex items-center text-[#D375B9] px-7 cursor-pointer shadow-md justify-between">
        <li className="flex items-center gap-3">
          ...
          <span className="md:text-[32px] text-2xl ">Your Car</span>
        </li>
